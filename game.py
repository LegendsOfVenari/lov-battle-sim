...
from venari import Aharas, Akulaw
from config import akulaw_base_stats, aharas_base_stats

# Create teams
player_team = [Aharas("Aharas", aharas_base_stats, 4), Akulaw("Akulaw", akulaw_base_stats, 6), Aharas("Aharas", aharas_base_stats, 3)]
