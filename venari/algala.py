...
from config import DamageType, wild_charge_base_damage, wild_charge_damage_type, wild_charge_accuracy
...
class Algala(Venari):
    ...
    def use_ability(self, target):
        ...
        self.deal_damage(target, wild_charge_base_damage, wild_charge_damage_type, wild_charge_accuracy)
        ...
        if not self.battle_handler.has_effect(self.armor()):
            self.deal_damage(self, wild_charge_base_damage, wild_charge_damage_type, wild_charge_accuracy)
